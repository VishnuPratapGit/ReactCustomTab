  ...
  return (
    <div
      ...
      className={`${display ? "opacity-50" : ""} ${showDrop
        ...
        } flex items-center justify-center origin-left flex-shrink-0 h-max p-1.5 px-2 transition-all font-quicksand duration-300 border-dashed border select-none text-neutral-300`}
    >
      +
    </div>
  );
