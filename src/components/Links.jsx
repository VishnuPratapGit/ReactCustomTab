...
const Links = ({ data, contextMenu, setDraggableId }) => {
  ...
  return (
    <a
      ...
      className="dark:text-white text-black dark:hover:text-white border-2 border-transparent flex justify-center items-center w-max gap-2 mr-3 flex-shrink-0 hover:border-neutral-600 p-1 px-2 h-min rounded-lg transition-all duration-500"
    >
